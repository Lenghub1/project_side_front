    ...
    <CP.Styled.Form>
      <FormContainer>
        <CP.Styled.Div>
          ...
          <Flex direction="column" gap="1.5rem" items="flex-start">
            <CP.Typography variant="body1">
              You can search for a company by typing in the correct company
              code.
            </CP.Typography>
            ...
            <Flex gap="1rem" justify="flex-end">
              ...
              <CP.Button type="submit" onClick={() => console.log("Hi")}>
                Login
              </CP.Button>
            </Flex>
          </Flex>
        ...
        <CP.Styled.Div>
          ...
          <CP.Typography variant="body1">
            If your manager hasn’t invited you yet, please contact and provide
            them your email or phone number to invite you
          </CP.Typography>
        </CP.Styled.Div>
      </FormContainer>
